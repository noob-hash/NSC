    ...
    <div class="container">
      <div class="row py-5 mt-4 align-items-center">
        ...
        <div class="col-md-7 col-lg-6 ml-auto">
          <form action="${pageContext.request.contextPath}/UserAuth?action=register">
            <div class="row">
              ...
              <div class="text-center w-auto">
                <p class="text-muted font-weight-bold">
                  Already Registered?
                  <a href="${pageContext.request.contextPath}/UserAuth?PageController=login" class="text-primary ml-2">Login</a>
                </p>
              </div>
            </div>
          </form>
